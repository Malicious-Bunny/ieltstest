              ...
              <div className="p-8">
                ...
                <div className="flex items-center justify-between mb-6">
                  ...
                  <div className="text-right">
                    <div className="text-3xl font-bold text-gray-900">{band.score}</div>
                    <div className="text-sm text-gray-500">Band Score</div>
                  </div>
                </div>

                {/* Title and Description */}
                <h3 className="text-xl font-bold text-gray-900 mb-2">{band.level}</h3>
                ...
                <ul className="space-y-2 mb-8">
                  {band.features.map((feature, index) => (
                    <li key={index} className="flex items-center text-sm text-gray-600">
                      <IoIosCheckmarkCircleOutline className="w-4 h-4 text-green-500 mr-2 flex-shrink-0" />
                      {feature}
                    </li>
                  ))}
                </ul>
                ...
                <div className="border-t pt-6">
                  <div className="flex items-center justify-between mb-4">
                    <div className="text-3xl font-bold text-gray-900">{band.price}</div>
                  ...
                  >
                    ORDER NOW
                    <BsArrowRightShort className="w-4 h-4 ml-2 inline" />
                  </button>
                </div>
              </div>
            </div>
